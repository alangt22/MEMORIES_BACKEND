...
const { createMemory, getMemories, getMemory, deleteMemory, updateMemory, toggleFavorite, addCommnent } = require("./controllers/MemoryController")
...
router.patch("/:id/comment", (req, res) => addCommnent(req, res))
